...
/**
 * Exemplo de Teste de Sumarização Melhorado
 *
 * Este arquivo demonstra como os testes de sumarização deveriam ser escritos
 * para realmente validar o comportamento do sistema.
 */
