            ...
            headerActions={
              ...
              >
                <button
                  ref={settingsBtnRef}
                  className={
                    "orchos-settings-btn" + (showSettings ? " active" : "")
                  }
          ...
          >
            <div className="transcription-flex-container">
              <TextEditor
                ...
                forwardedRef={
                  transcriptionRef as React.RefObject<HTMLTextAreaElement>
                }
                readOnly={true}
              />
              ...
              >
                ...
                >
                  ...
                  <button
                    className={`orchos-quantum-btn orchos-btn-record orchos-btn-lg${
                      microphoneState === MicrophoneState.Open
                        ? " orchos-btn-recording"
                        : ""
                    }`}
                      ...
                      >
                        <g filter="url(#neural-record-glow)">
                          ...
                          <circle
                            ...
                            className="neural-core-record"
                          />

                          {/* Neural wave patterns - converging onto consciousness center */}
                          <path
                            className="neural-wave wave-1"
                            d="M16 16 C10 14, 8 18, 5 16"
                            stroke="url(#gradient-neural)"
                            strokeWidth="1.5"
                            strokeLinecap="round"
                          />
                          <path
                            className="neural-wave wave-2"
                            d="M16 16 C10 18, 8 14, 5 18"
                            stroke="url(#gradient-neural)"
                            strokeWidth="1.5"
                            strokeLinecap="round"
                          />
                          <path
                            className="neural-wave wave-3"
                            d="M16 16 C22 14, 24 18, 27 16"
                            stroke="url(#gradient-neural)"
                            strokeWidth="1.5"
                            strokeLinecap="round"
                          />
                          <path
                            className="neural-wave wave-4"
                            d="M16 16 C22 18, 24 14, 27 18"
                            stroke="url(#gradient-neural)"
                            strokeWidth="1.5"
                            strokeLinecap="round"
                          />
                          <path
                            className="neural-wave wave-5"
                            d="M16 16 C14 10, 18 8, 16 5"
                            stroke="url(#gradient-neural)"
                            strokeWidth="1.5"
                            strokeLinecap="round"
                          />
                          <path
                            className="neural-wave wave-6"
                            d="M16 16 C18 10, 14 8, 18 5"
                            stroke="url(#gradient-neural)"
                            strokeWidth="1.5"
                            strokeLinecap="round"
                          />
                          <path
                            className="neural-wave wave-7"
                            d="M16 16 C14 22, 18 24, 16 27"
                            stroke="url(#gradient-neural)"
                            strokeWidth="1.5"
                            strokeLinecap="round"
                          />
                          <path
                            className="neural-wave wave-8"
                            d="M16 16 C18 22, 14 24, 18 27"
                            stroke="url(#gradient-neural)"
                            strokeWidth="1.5"
                            strokeLinecap="round"
                          />
                      ...
                      >
                        <g filter="url(#send-glow)">
                          ...
                          <circle
                            ...
                            className="neural-core-send"
                          />

                          {/* Neural wave patterns - diverging from consciousness center to right (sending) */}
                          <path
                            className="neural-send-wave wave-1"
                            d="M8 12 C14 10, 16 14, 20 12"
                            stroke="url(#gradient-send)"
                            strokeWidth="1.5"
                            strokeLinecap="round"
                          />
                          <path
                            className="neural-send-wave wave-2"
                            d="M8 12 C14 14, 16 10, 20 14"
                            stroke="url(#gradient-send)"
                            strokeWidth="1.5"
                            strokeLinecap="round"
                          />
                          ...
                          <path
                            ...
                            className="neural-send-arrow"
                          />

                          {/* Additional neural patterns */}
                          <path
                            className="neural-send-wave wave-3"
                            d="M8 12 C10 8, 12 7, 10 4"
                            stroke="url(#gradient-send)"
                            strokeWidth="1"
                            strokeLinecap="round"
                            strokeOpacity="0.6"
                          />
                          <path
                            className="neural-send-wave wave-4"
                            d="M8 12 C6 8, 4 7, 6 4"
                            stroke="url(#gradient-send)"
                            strokeWidth="1"
                            strokeLinecap="round"
                            strokeOpacity="0.6"
                          />
                          <path
                            className="neural-send-wave wave-5"
                            d="M8 12 C10 16, 12 17, 10 20"
                            stroke="url(#gradient-send)"
                            strokeWidth="1"
                            strokeLinecap="round"
                            strokeOpacity="0.6"
                          />
                          <path
                            className="neural-send-wave wave-6"
                            d="M8 12 C6 16, 4 17, 6 20"
                            stroke="url(#gradient-send)"
                            strokeWidth="1"
                            strokeLinecap="round"
                            strokeOpacity="0.6"
            ...
            icon={
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                <rect
                  ...
                  strokeWidth="2"
                />
                <circle cx="10" cy="10" r="2" fill="#ff80ab" />
              </svg>
            }
          >
            <TextEditor
