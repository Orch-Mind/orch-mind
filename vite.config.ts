  ...
  return {
            ...
            build: {
              ...
              rollupOptions: {
                external: [
                  ...
                  /\.node$/,
                  // P2P modules - native Node.js modules for Electron
                  "hyperswarm",
                  "b4a",
                  "hypercore-crypto",
                  "hypercore",
            ...
            build: {
              ...
              rollupOptions: {
                external: [
                  ...
                  "v8",
                  "zlib",
                  // P2P modules - should not be bundled in preload
                  "hyperswarm",
                  "b4a",
                  "hypercore-crypto",
                  "hypercore",
    ...
    build: {
      ...
      rollupOptions: {
        external: [
          ...
          /^@duckdb\/node-bindings/,
          /\.node$/,
          // P2P modules - should only be used in Electron main process
          "hyperswarm",
          "b4a",
          "hypercore-crypto",
          "hypercore",
    ...
    optimizeDeps: {
      ...
      exclude: [
        ...
        "conf",
        "electron",
        // P2P modules - should not be optimized for browser
        "hyperswarm",
        "b4a",
        "hypercore-crypto",
        "hypercore",
